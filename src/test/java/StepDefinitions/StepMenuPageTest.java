...
//    }
    ...
    public void doyClicEnElDetalleDelProducto() {
        ...
        executor2.executeScript("arguments[0].click();", driver.findElement(By.xpath("//div[@id='render-store.custom.checkout-io']//a/img")));
        try {
            Thread.sleep(2000);
    ...
    public void ingresarCorreoElectronicoYDarClicEnConfirmar() {
        try {
            ...
            ((JavascriptExecutor) driver).executeScript("arguments[0].click();", confirmarBoton);
    ...
    public void llenamosElFormularioDeIngresaTusDatos() throws InterruptedException, IOException {
        ...
        Thread.sleep(6000); // Espera fija de 6 segundos
        firstNameElement.click();
        firstNameElement.sendKeys("TuNombre"); // Ingresar el apellido
        ...
        lastNameElement.sendKeys("TuApellido"); // Seleccionar el tipo de documento
        ...
        Thread.sleep(1000); // Espera fija de 1 segundo
        documentTypeSelect.click(); // Seleccionar "Cédula extranjería"
        ...
        Thread.sleep(1000); // Espera fija de 1 segundo
        documentTypeOption.click(); // Ingresar el número de documento
        ...
        documentElement.sendKeys("123456789"); // Ingresar el número de teléfono
        ...
        try { // Verificar la existencia y visibilidad del primer checkbox
            WebElement checkbox1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#render-store\\.custom\\.checkout-io .exito-checkout-io-0-x-privacyPolicyAndTermsContainer .exito-checkout-io-0-x-termsContainer.exito-checkout-io-0-x-checked")));
            ...
            e.printStackTrace(); // Captura de pantalla para depuración
            File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(screenshot, new File("screenshot.png"));
            System.out.println("TimeoutException: No se pudo encontrar el elemento dentro del tiempo especificado.");
        } catch (Exception e) {
            e.printStackTrace(); // Manejo de excepciones personalizado si es necesario
        }
        try { // Verificar la existencia y visibilidad del segundo checkbox
            WebElement checkbox2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#render-store\\.custom\\.checkout-io .exito-checkout-io-0-x-privacyPolicyAndTermsContainer article:nth-child(2) label div input[type='checkbox']")));
